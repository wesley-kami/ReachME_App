...
export default class extends AbstractView{
    ...
    async getContent(){
        ...
        <div class="text-center flex flex-col items-center justify-center h-screen">
            ...
            <a href="/" page-link class="inline-block px-6 py-2 bg-purple-600 text-white rounded hover:bg-purple-700 transition">Go Home</a>
        </div>`
    }

    async scriptLink(){
        const intro = document.getElementById('intro');
        intro.innerHTML = await this.getContent();
    }
}